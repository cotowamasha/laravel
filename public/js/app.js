        ...
        [
          ...
          _c(
            ...
            _vm._l(_vm.menu, function(item, i) {
              return _c("router-link", { key: i, attrs: { to: item.to } }, [
                _c(
                  "div",
                  {
                    class: [
                      "menu__item",
                      _vm.getRoute === item.to ? "active" : ""
                    ]
                  },
                  [
                    _vm._v(
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "header__sign-in" }, [
      _c("button", { staticClass: "header__btn-search" }, [
...
/* harmony import */ var _layouts_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./layouts/default */ "./resources/js/layouts/default.vue");
// require('./bootstrap');
...
var app = new Vue({
  el: '#app',
  render: function render(h) {
    return h(_layouts_default__WEBPACK_IMPORTED_MODULE_2__["default"]);
  },
